...
void main() {
  group('Doggo Service', () {
    ...
    group('works on happy paths', () {
      test(
        ...
        ServiceResult doggoBreedsResult =
            await doggoService.getDoggoDiversityData();

        expect(doggoBreedsResult.success, true);
      });
    });

    group('deals with invalid json formatting in responses', () {
    ...
    group('handles execptions and errors', () {
...
Future<void> _testErrorClient(http.Client mockClient) async {
  ...
  // Test functionality
  ServiceResult doggoBreedsResult = await doggoService.getDoggoDiversityData();
